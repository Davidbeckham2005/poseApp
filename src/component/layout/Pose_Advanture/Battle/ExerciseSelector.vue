...
// Define the available attack/exercise types with stats and colors
const attacks = ref([
  {

    id: 'pushup',
    name: 'Push-up',
    icon: BicepsFlexed, // Using emoji for simplicity, replace with SVG/Img as needed
    energy: 15,
    damage: 25,
  ...
  },
  {
    id: 'squat',
    name: 'Squat',
    icon: '🏋️', // Replace with a barbell icon if desired
    energy: 12,
    damage: 20,
...
<template>
  <div class="relative max-w-6xl space-y-3 w-full m-auto border-gray-800 rounded-2xl p-4 border border-gray-800">
    <div class="mb-2">
    ...
    <div class="flex items-center justify-center">
      <button @click="handle_menu"
        class="flex items-center w-full rounded-2xl bg-gray-800  py-2 text-xl font-medium transition-colors hover:bg-neutral-700 active:bg-neutral-800 active:scale-95 active:translate-y-0.5">
