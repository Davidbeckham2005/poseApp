<template>
    <div
        ...
        <div class="p-6 space-y-5">
            ...
            <div class="pt-2">
                <button
                    class="w-full flex items-center justify-center gap-3 bg-[#248da5]/10 hover:bg-[#248da5]/20 text-[#248da5] py-4 rounded-xl font-bold transition-colors shadow-inner border border-[#248da5]/15">
