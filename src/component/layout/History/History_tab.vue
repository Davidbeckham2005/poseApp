<template>
    <div>
        ...
        <button class=" btn-outline" @click="delete_select">Delete</button>
...
import { Video, CircleCheckBig, Shell, ChartNoAxesCombined, Trophy } from 'lucide-vue-next';
import { ref, watch } from 'vue';
const List_Video = ref([])
const append_on_delete_list = (path) => {
    List_Video.value.push(path)
}
watch(List_Video, (newVal) => {
    let data = {
